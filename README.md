...
<p>
    ...
    <a href="https://github.com/KilimcininKorOglu/mikmik"><img src="https://img.shields.io/badge/Version-1.0.2-2E8B57?style=for-the-badge" alt="Version 1.0.2"></a>
...
> [!IMPORTANT]
> MikMik is now officially in Beta (v1.0.2). The core agent, multi-provider routing, and TUI are stable enough for daily driving. Expect rough edges around the experimental features flagged below. Bug reports and pull requests are welcome.
